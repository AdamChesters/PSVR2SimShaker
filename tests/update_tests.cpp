...
Json fixture(const std::string& tag){
    ...
    const auto name="PSVR2SimShaker-"+version+"-Setup.exe";
...
int main(int argc,char** argv){
    try{
        ...
        const auto folder=fs::temp_directory_path()/(L"PSVR2SimShaker-update-tests-"+std::to_wstring(GetCurrentProcessId()));
