...
$archive = Join-Path $projectRoot 'dist\PSVR2SimShaker-0.1.0-Windows-x64.zip'
...
Get-FileHash -Algorithm SHA256 -LiteralPath $archive,(Join-Path $projectRoot 'dist\PSVR2SimShaker-0.1.0-Setup.exe') | ForEach-Object {
